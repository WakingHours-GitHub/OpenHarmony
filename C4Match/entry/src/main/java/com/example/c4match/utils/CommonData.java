...
public class CommonData {
     ...
     * MainAbility name
     */
    public static final String MAIN_ABILITY_CLASS_NAME = MainAbility.class.getName();

    /**
     * MathGameService name
     */
    public static final String STUDY_CLASS_NAME = StudySystem.class.getName();

    /**
     * PictureGameServiceAbility name
     */
    public static final String GAME_CLASS_NAME = GameSystem.class.getName();
